...
## Environments
- Preview: https://main--eds-poc-rde--Shaik-Tajuddin.aem.page/
- Live: https://main--eds-poc-rde--Shaik-Tajuddin.aem.live/
...
1. Open the `ur-rde` directory in your favorite IDE and start coding :)
